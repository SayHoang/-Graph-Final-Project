"""
Extended Adjacency List implementation for MultiGraph
...
class ExtendedAdjacencyList:
    """Structure to represent extended adjacency list for multigraph"""
...
def read_extended_adjacency_list_from_file(file_name: str) -> ExtendedAdjacencyList:
    """
    Read extended adjacency list from edge list file with self-loop removal
...
def display_extended_adjacency_list(extended_list: ExtendedAdjacencyList) -> None:
    ...
    """
    print("=== Extended Adjacency List (MultiGraph) ===")
...
def write_extended_adjacency_list_to_file(extended_list: ExtendedAdjacencyList, file_name: str) -> None:
    ...
    try:
        with open(file_name, 'w') as output_file:
            output_file.write("=== Extended Adjacency List (MultiGraph) ===\n")
...
def convert_adjacency_list_to_extended(adjacency_data: List[List[int]], 
    ...
    """
    Convert adjacency list to extended adjacency list with self-loop removal
    ...
    if self_loop_count > 0:
        print(f"Warning: {self_loop_count} self-loops removed during conversion to multigraph extended list")
...
def convert_matrix_to_extended_adjacency_list(matrix_data: List[List[int]], 
                                            number_of_vertices: int) -> ExtendedAdjacencyList:
    """
    Convert adjacency matrix to extended adjacency list with self-loop removal
...
def convert_adjacency_map_to_extended(outgoing_connections: Dict, 
    ...
    """
    Convert adjacency map to extended adjacency list with self-loop removal
