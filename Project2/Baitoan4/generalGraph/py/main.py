...
for General Graph (supports self-loops and multiple edges)
"""
...
def demonstrate_graph_representation_conversions():
    ...
    print("=== Complete General Graph Representation Conversion Demo ===")
...
def test_graph_representation_consistency():
    ...
    print("=== Testing Graph Representation Consistency ===")
...
def main():
    """Main function to demonstrate general graph representation conversions"""
    print("General Graph Representation Conversion Program")
    print("Supporting: Self-loops and Multiple edges")
