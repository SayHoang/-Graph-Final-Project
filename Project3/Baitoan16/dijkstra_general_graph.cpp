...
/**
 * @brief Applies Dijkstra's algorithm to find shortest paths from source vertex
...
/**
 * @brief Reads graph input from file
 ...
 */
vector<vector<DistanceVertexPair>> readGraphInput(ifstream& inputFile, int& numberOfVertices, int& numberOfEdges) {
...
int main() {
    ...
    vector<vector<DistanceVertexPair>> adjacencyList = readGraphInput(inputFile, numberOfVertices, numberOfEdges);
